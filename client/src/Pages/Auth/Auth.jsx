      ...
      <div className="Auth_container2">
        ...
        <div className="btns_Auth">
          {User?.result.name ? (
            <>
              {
                <Link to={`/chanel/${User?.result._id}`} className="btn_Auth roboto-light">
                  Your Chanel
                </Link>
              }
            </>
            ...
            <>
              <input
                type="submit"
                className="btn_Auth roboto-light"
          ...
          <div>
            <GoogleLogout
              ...
              render={(renderProps) => (
                <div onClick={renderProps.onClick} className="btn_Auth roboto-light">
                  <BiLogOut />
                  Log Out
                </div>
              )}
